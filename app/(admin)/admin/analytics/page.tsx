    ...
    <div className="space-y-8">
      ...
      <div className="glass-card p-6 md:p-8 rounded-3xl organic-shadow">
        ...
        <p className="text-on-surface-variant text-sm mt-1">
          Deep-dive telemetry into revenue breakdown, farmer performance
          rankings, and category growth trends.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-on-surface-variant text-xs font-medium">
                Monthly revenue performance (6 Months)
              </p>
            </div>
        ...
        <div className="glass-card organic-shadow rounded-3xl p-8 flex flex-col justify-between">
          <div className="mb-6">
            ...
            <p className="text-on-surface-variant text-xs font-medium">
              Distribution across produce categories
            </p>
          </div>
                ...
                <div className="flex justify-between text-xs font-bold">
                  <span className="text-on-surface capitalize flex items-center gap-1.5">
                    <span className="text-lg">
                      {CATEGORY_ICONS[
                        cat.category as keyof typeof CATEGORY_ICONS
                      ] || "📦"}
                    </span>
                    {cat.category}
                  </span>
            ...
            <table className="w-full text-left text-sm text-on-surface">
              ...
              <tbody className="divide-y divide-outline-variant/10">
                {topFarmers.map((item, i) => (
                  ...
                  >
                    <td className="px-6 py-4 font-bold text-outline">
                      #{i + 1}
                    </td>
                ...
                {topProducts.map((item, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-xs font-medium text-on-surface-variant capitalize">
                      {
                        CATEGORY_ICONS[
                          item.product.category as keyof typeof CATEGORY_ICONS
                        ]
                      }{" "}
...
function KpiCard({
  ...
  return (
    <div className="glass-card organic-shadow rounded-3xl p-6 flex flex-col justify-between hover:-translate-y-0.5 transition-all">
      ...
      <div>
        <div className="font-heading text-2xl font-extrabold text-primary tracking-tight">
          {value}
        </div>
        <div className="text-[11px] font-bold text-secondary mt-1">
          {change}
        </div>
      </div>
    </div>
