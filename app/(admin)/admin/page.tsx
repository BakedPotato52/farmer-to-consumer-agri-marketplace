              ...
              pendingFarmers.map((farmer) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Link
                      href={`/admin/farmers`}
                      className="flex-1 text-center bg-emerald-600 text-white text-xs py-2 rounded-md hover:bg-emerald-700 transition-colors font-medium"
                    >
                      Review
                    </Link>
                  </div>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col">
      <div className="flex justify-between items-start mb-4">
        ...
        <div
          className={`w-8 h-8 rounded-lg flex items-center justify-center text-lg ${colorMap[color]}`}
        >
          {icon}
        </div>
      </div>
