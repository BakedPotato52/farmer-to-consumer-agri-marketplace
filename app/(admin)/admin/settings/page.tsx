  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Configure global marketplace parameters and preferences.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <form onSubmit={handleSave} className="p-6 space-y-6">
          ...
          <div className="space-y-4 pt-4">
            <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2">Financials</h2>
            
            <div className="max-w-md">
              <label className="block text-sm font-medium text-gray-700 mb-1">Platform Commission Rate (%)</label>
              <p className="text-xs text-gray-500 mb-2">Percentage fee taken from each successful order.</p>
