        ...
        {step === 1 && (
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">
              How do you want to use FarmFresh?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Sell your harvest directly to consumers.
                </p>
              </button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-emerald-500 outline-none"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  name="cropTypes"
                  placeholder="e.g. Wheat, Potatoes, Tomatoes"
                  required
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-emerald-500 outline-none"
                />
              </div>
