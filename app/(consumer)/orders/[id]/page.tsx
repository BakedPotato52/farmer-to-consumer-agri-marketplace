      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="glass-card organic-shadow rounded-3xl p-6 md:p-8 space-y-6">
            <h2 className="font-heading text-xl font-bold text-primary">Items Ordered</h2>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="glass-card organic-shadow rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs text-on-surface-variant">
              <div>
                <span className="text-outline uppercase font-bold block mb-1">Address</span>
                <p className="text-on-surface font-medium">{order.deliveryAddress}</p>
              </div>
              <div>
                <span className="text-outline uppercase font-bold block mb-1">Date & Time Slot</span>
              ...
              {order.notes && (
                <div>
                  <span className="text-outline uppercase font-bold block mb-1">Notes</span>
          ...
          <div className="bg-surface-container-low rounded-3xl p-6 organic-shadow border border-outline-variant/10 space-y-3">
            <span className="text-xs font-bold text-outline uppercase tracking-wider block">Grower</span>
            <div className="flex items-center justify-between">
              <div className="font-heading font-bold text-primary text-base">{order.farmerName}</div>
              <Link
