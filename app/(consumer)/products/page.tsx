      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-64 shrink-0">
          <form
            method="GET"
            action="/products"
            className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 space-y-6 sticky top-24"
          >
              ...
              <div className="space-y-2">
                {["vegetables", "fruits", "dairy", "grains", "herbs"].map(
                  (c) => (
                    <label
                      key={c}
                      className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 capitalize cursor-pointer"
                    >
                      <input
                        type="radio"
                        name="category"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`h-48 w-full bg-gradient-to-br ${bgGradient} relative`}
                    >
                      {product.isOrganic && (
