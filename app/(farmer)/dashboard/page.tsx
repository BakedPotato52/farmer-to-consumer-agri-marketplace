                ...
                {recentOrders.length === 0 ? (
                  ...
                  recentOrders.map((order) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-medium capitalize ${statusColors[order.status]}`}
                        >
                          {order.status}
                        </span>
                      </td>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="block w-full py-2.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white text-center rounded-lg font-medium transition-colors"
              >
                + Add New Product
              </Link>
              <Link
                href="/dashboard/orders"
                className="block w-full py-2.5 px-4 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-center rounded-lg font-medium transition-colors border border-emerald-200"
              >
                View All Orders
              </Link>
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="h-48 flex items-end justify-between gap-2 pt-4">
              {chartData.map((h, i) => (
                ...
                >
                  <div
                    className="w-full bg-emerald-100 rounded-t-sm relative flex items-end justify-center group-hover:bg-emerald-200 transition-colors"
                    style={{ height: `100%` }}
                  >
                    <div
