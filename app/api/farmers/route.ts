...
import { getAllFarmers, getVerifiedFarmers, searchFarmers } from "@/lib/data/farmers";
...
export async function GET(request: NextRequest) {
  ...
  const filters: any = {};
  if (searchParams.has("method")) filters.farmingMethod = searchParams.get("method") as FarmingMethod;
