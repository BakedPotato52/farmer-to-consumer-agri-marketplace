...
export async function GET(request: NextRequest) {
  ...
  if (searchParams.has("organic")) filters.isOrganic = searchParams.get("organic") === "true";
  ...
  if (searchParams.has("farmerId")) filters.farmerId = searchParams.get("farmerId");
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const required = ["name", "description", "category", "price", "unit", "quantityAvailable"];
